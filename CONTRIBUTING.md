...
- This project uses the git-flow discipline.
    - **Do not** submit pull requests against the *main* branch!
    - **Do** submit pull requests against the *develop* branch!
- If this project has a version, it uses [semantic versioning](http://semver.org).

## Contributor license agreement

By supplying code to this module in patches, tickets and pull requests, you agree to assign copyright
of that code to Quinn Interactive, Inc., on the condition that these code changes are released under the
